...
class AdminMenu:
    def __init__(self, top=None):
        ...
        self.btnCategorias = Button(admMenu, text="Categorias")
        self.btnCategorias.place(relx=0.536, rely=0.508, width=146, height=63)
        self.btnCategorias.configure(background="#ffffff", activebackground="#DEE2E6", borderwidth="0")
        self.btnCategorias.configure(cursor="hand2")
        self.btnCategorias.configure(font="-family {Calibri} -size 12")

        self.btnEstatisicas = Button(admMenu, text="Estatisticas")
        self.btnEstatisicas.place(relx=0.732, rely=0.508, width=146, height=63)
        ...
        self.btnVendas.place(relx=0.14, rely=0.63, width=146, height=63)
